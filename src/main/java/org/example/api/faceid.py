...
try:
    ...
    print(json.dumps({"error": "face_recognition module not installed or missing dependencies: " + str(e)}))
    sys.exit(1)
...
def main():
    ...
    try:
        ...
        if len(known_encodings) > 0 and len(unknown_encodings) > 0:
            ...
            # Aucun visage détecté dans l'une des images
            match = False
        ...
        # Attraper toute erreur imprévue
