...
public class DoctorController {
    ...
    @FXML
    private Hyperlink handleStatistiques; // Ajouté pour les statistiques
    ...
    // ==================== Partie ajoutée pour gérer la navigation vers Statistiques =====================
    ...
    private void handleAfficherStatistiques(ActionEvent event) {
        try {
            ...
            if (fxmlUrl == null) {
                throw new IOException("Fichier FXML introuvable: /Statistiques.fxml");
            }

            Parent fxml = FXMLLoader.load(fxmlUrl);
            contentPane.getChildren().setAll(fxml);
        } catch (IOException e) {
