...
public class StatistiqueConsultation {
    ...
    public void initialize() throws SQLException {
        Map<String, Integer> monthCount = serviceConsultation.countConsultationsByMonth();  // Méthode à implémenter dans ton service
        ...
        barChart.setTitle("Répartition des consultations par mois");
        ...
        barChart.getXAxis().setLabel("Mois");
        barChart.getYAxis().setLabel("Nombre de consultations");
        ...
        yAxis.setUpperBound(monthCount.size() * 2);  // Ajuste la limite supérieure
